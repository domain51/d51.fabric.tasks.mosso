...
setup(
    name='d51.fabric.tasks.mosso',
    version='0.1', # TODO: move this into Dolt.get_version()
    description='Fabric tasks for handling basic management tasks Mosso (Rackspace Cloud)',
    author='Domain51',
    author_email='official@domain51.com',
    url='http://github.com/domain51/d51.fabric.tasks.mosso/',
    packages=packages,
    classifiers=[
